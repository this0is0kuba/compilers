...
public interface scalaToCppListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link scalaToCppParser#printList}.
	 * @param ctx the parse tree
	 */
	void enterPrintList(scalaToCppParser.PrintListContext ctx);
	/**
	 * Exit a parse tree produced by {@link scalaToCppParser#printList}.
	 * @param ctx the parse tree
	 */
	void exitPrintList(scalaToCppParser.PrintListContext ctx);
	/**
	 * Enter a parse tree produced by {@link scalaToCppParser#printListElement}.
	 * @param ctx the parse tree
	 */
	void enterPrintListElement(scalaToCppParser.PrintListElementContext ctx);
	/**
	 * Exit a parse tree produced by {@link scalaToCppParser#printListElement}.
	 * @param ctx the parse tree
	 */
	void exitPrintListElement(scalaToCppParser.PrintListElementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link scalaToCppParser#argumentListElement}.
	 * @param ctx the parse tree
	 */
	void enterArgumentListElement(scalaToCppParser.ArgumentListElementContext ctx);
	/**
	 * Exit a parse tree produced by {@link scalaToCppParser#argumentListElement}.
	 * @param ctx the parse tree
	 */
	void exitArgumentListElement(scalaToCppParser.ArgumentListElementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link scalaToCppParser#listLiteralElement}.
	 * @param ctx the parse tree
	 */
	void enterListLiteralElement(scalaToCppParser.ListLiteralElementContext ctx);
	/**
	 * Exit a parse tree produced by {@link scalaToCppParser#listLiteralElement}.
	 * @param ctx the parse tree
	 */
	void exitListLiteralElement(scalaToCppParser.ListLiteralElementContext ctx);
	/**
